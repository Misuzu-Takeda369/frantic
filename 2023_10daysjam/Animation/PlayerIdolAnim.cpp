...
void PlayerIdolAnim::Initialize()
{
	...
	_lunaTexture[0]=Novice::LoadTexture("./AnimResources/player_luna_Idol0.png");
	_lunaTexture[1] = Novice::LoadTexture("./AnimResources/player_luna_Idol1.png");
	_lunaTexture[2] = Novice::LoadTexture("./AnimResources/player_luna_Idol2.png");
